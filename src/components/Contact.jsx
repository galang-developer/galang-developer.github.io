...
const socialLinks = [
    ...
    {
        href: 'https://www.instagram.com/sai.satoruu',
        ...
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="cursor-scale headline-2 lg:max-w-[12ch] reveal-up">
                        Mari Berkolaborasi!
                    </h2>

                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        Punya ide proyek aplikasi mobile atau website? Hubungi saya sekarang, dan mari wujudkan bersama!
                    </p>

                    <div className="cursor-scale flex items-center gap-2 mt-auto">
                        {
                ...
                <form action="https://getform.io/f/anlnevda" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="cursor-hide md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label reveal-up">Nama</label>
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Galang" className="text-field reveal-up" />
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label reveal-up">Email</label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="galang@example.com" className="text-field reveal-up" />
                        </div>
                    </div>

                    <div className="cursor-hide mb-4">
                        <label htmlFor="message" className="label reveal-up">Pesan</label>
                        <textarea name="message" id="message" placeholder="Hi!" required className="text-field hide-scrollbar resize-y min-h-32 max-h-80 reveal-up"></textarea>
                    </div>

                    <button type="submit" className="cursor-scale btn btn-primary [&]:max-w-full w-full justify-center reveal-up">
                        Submit
                    </button>
                </form>
            </div>
